...
- `starworkAudit/`：规划中的 Hub 巡检解读 skill，基于 `starwork audit --json` 判断多个 Satellite 的健康状况，并在用户确认后生成 `starwork repair --blueprint` 修复施工图。详细 SPEC 见 `starworkAudit-spec.md`。
