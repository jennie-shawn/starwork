...
| `matter-mode` | 提供 `matters/` 事项机制，适合长期项目和跨会话接力。 |
| `decisions` | 提供高影响决策记录，不记录普通会议流水。 |
...
| `zh-shared-matter` | 主库 + 多卫星项目用户 | 主库分发身份、教训、知识、skills；卫星项目维护自己的事项和正式事实源。 |
